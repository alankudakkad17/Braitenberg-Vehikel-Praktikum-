...
class Vehicle:
    ...
    def move(self, sun_position):
        ...
        left_distance = self.left_sensor_position*threshold(left_distance)
        right_distance = self.right_sensor_position*threshold(right_distance)
        ...
        # debug
        text = f"left distance: {left_distance:.4f}"
        text += f"\nRight distance: {right_distance:.4f}"
        text += f"\nspeed: {speed:.4f}"
